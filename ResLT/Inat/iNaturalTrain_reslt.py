...
parser.add_argument('--num_classes', default=8142, type=int)
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.pretrained:
        ...
        model = getattr(nets, args.arch)(num_classes=args.num_classes, after_1x1conv=args.after_1x1conv, gamma=args.gamma)
